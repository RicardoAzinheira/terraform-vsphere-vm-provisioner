...
The author of this module takes no responsability of its use by anyone, although this was properly tested against a proper vSphere Infra-Structure we still recommend proper testing before you use this in your production environment.
