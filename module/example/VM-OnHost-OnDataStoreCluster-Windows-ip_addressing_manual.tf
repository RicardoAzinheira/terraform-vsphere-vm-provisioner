...
// VM on a single Host and a Datastore Cluster, with Windows and manual IP addressing (Variable defined values).
...
// Module
//
module "VM-OnHost-OnDataStoreCluster-Windows-ip_addressing_manual" {
