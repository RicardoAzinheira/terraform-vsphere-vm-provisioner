...
// VM on a single Host and a single Datastore, with Linux and manual IP addressing (Variable defined values).
...
// Module
//
module "VM-OnHost-OnDataStore-Linux-ip_addressing_manual" {
