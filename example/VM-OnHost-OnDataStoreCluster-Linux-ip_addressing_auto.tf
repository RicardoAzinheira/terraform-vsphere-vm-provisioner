...
// VM on a single Host and a Datastore Cluster, with Linux and automatic (DHCP) IP addressing.
...
// Module
//
module "VM-OnHost-OnDataStoreCluster-Linux-ip_addressing_auto" {
...
// Module outputs
//
output "VM-OnHost-OnDataStoreCluster-Linux-ip_addressing_auto-IP-Address" {
  value = module.VM-OnHost-OnDataStoreCluster-Linux-ip_addressing_auto.VM-OnHost-OnDataStoreCluster-Linux-ip_addressing_auto-IPaddress
}