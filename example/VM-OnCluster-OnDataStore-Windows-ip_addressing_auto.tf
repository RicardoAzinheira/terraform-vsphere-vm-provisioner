...
// VM on a Compute Cluster and a single Datastore, with Windows and automatic (DHCP) IP addressing.
...
// Module
//
module "VM-OnCluster-OnDataStore-Windows-ip_addressing_auto" {
...
// Module outputs
//
output "VM-OnCluster-OnDataStore-Windows-ip_addressing_auto-IP-Address" {
  value = module.VM-OnCluster-OnDataStore-Windows-ip_addressing_auto.VM-OnCluster-OnDataStore-Windows-ip_addressing_auto-IPaddress
}