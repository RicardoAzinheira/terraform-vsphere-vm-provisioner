...
// VM on a Compute Cluster and a single Datastore, with Linux and manual IP addressing (Variable defined values).
...
// Module
//
module "VM-OnCluster-OnDataStore-Linux-ip_addressing_manual" {
