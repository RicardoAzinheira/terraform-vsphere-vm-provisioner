...
// VM on a single Host and a Datastore Cluster, with Windows and automatic (DHCP) IP addressing.
...
// Module
//
module "VM-OnHost-OnDataStoreCluster-Windows-ip_addressing_auto" {
...
// Module outputs
//
output "VM-OnHost-OnDataStoreCluster-Windows-ip_addressing_auto-IP-Address" {
  value = module.VM-OnHost-OnDataStoreCluster-Windows-ip_addressing_auto.VM-OnHost-OnDataStoreCluster-Windows-ip_addressing_auto-IPaddress
}