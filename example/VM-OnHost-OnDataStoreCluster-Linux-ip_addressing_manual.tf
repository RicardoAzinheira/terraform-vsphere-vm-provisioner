...
// VM on a single Host and a Datastore Cluster, with Linux and manual IP addressing (Variable defined values).
...
// Module
//
module "VM-OnHost-OnDataStoreCluster-Linux-ip_addressing_manual" {
