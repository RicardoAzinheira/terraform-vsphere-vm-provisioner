...
// VM on a Compute Cluster and a single Datastore, with Windows and manual IP addressing (Variable defined values).
...
// Module
//
module "VM-OnCluster-OnDataStore-Windows-ip_addressing_manual" {
