...
// VM on a single Host and a single Datastore, with Windows and manual IP addressing (Variable defined values).
...
// Module
//
module "VM-OnHost-OnDataStore-Windows-ip_addressing_manual" {
