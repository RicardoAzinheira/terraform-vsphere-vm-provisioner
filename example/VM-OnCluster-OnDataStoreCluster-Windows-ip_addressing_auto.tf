...
// VM on a Cluster and a Datastore Cluster, with Windows and automatic (DHCP) IP addressing.
...
// Module
//
module "VM-OnCluster-OnDataStoreCluster-Windows-ip_addressing_auto" {
...
// Module outputs
//
output "VM-OnCluster-OnDataStoreCluster-Windows-ip_addressing_auto-IP-Address" {
  value = module.VM-OnCluster-OnDataStoreCluster-Windows-ip_addressing_auto.VM-OnCluster-OnDataStoreCluster-Windows-ip_addressing_auto-IPaddress
}