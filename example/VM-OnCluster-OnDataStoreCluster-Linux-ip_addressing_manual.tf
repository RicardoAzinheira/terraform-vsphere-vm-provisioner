...
// VM on a Compute Cluster and a Datastore Cluster, with Linux and manual IP addressing (Variable defined values).
...
// Module
//
module "VM-OnCluster-OnDataStoreCluster-Linux-ip_addressing_manual" {
