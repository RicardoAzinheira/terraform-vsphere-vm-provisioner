...
// VM on a Compute Cluster and a single Datastore, with Linux and automatic (DHCP) IP addressing.
...
// Module
//
module "VM-OnCluster-OnDataStore-Linux-ip_addressing_auto" {
...
// Module outputs
//
output "VM-OnCluster-OnDataStore-Linux-ip_addressing_auto-IP-Address" {
  value = module.VM-OnCluster-OnDataStore-Linux-ip_addressing_auto.VM-OnCluster-OnDataStore-Linux-ip_addressing_auto-IPaddress
}